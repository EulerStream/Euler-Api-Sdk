...
namespace EulerApiSdk.Model
{
    ...
    public partial class TokenErrorResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TokenErrorResponse(string error, Option<string?> errorDescription = default)
        {
            Error = error;
    ...
    public class TokenErrorResponseJsonConverter : JsonConverter<TokenErrorResponse>
    {
        ...
        public override TokenErrorResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!error.IsSet)
                throw new ArgumentException("Property is required for class TokenErrorResponse.", nameof(error));
            ...
            return new TokenErrorResponse(error.Value!, errorDescription);
        }
        ...
        {
            if (tokenErrorResponse.Error == null)
