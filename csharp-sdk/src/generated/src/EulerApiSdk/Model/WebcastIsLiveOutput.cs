...
namespace EulerApiSdk.Model
{
    ...
    /// WebcastIsLiveOutput
    /// </summary>
    public partial class WebcastIsLiveOutput : IValidatableObject
    {
        /// <summary>
    ...
    public class WebcastIsLiveOutputJsonConverter : JsonConverter<WebcastIsLiveOutput>
    {
        ...
        public override WebcastIsLiveOutput Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class WebcastIsLiveOutput.");

            return new WebcastIsLiveOutput(data);
        }

        /// <summary>
        /// Serializes a <see cref="WebcastIsLiveOutput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webcastIsLiveOutput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WebcastIsLiveOutput webcastIsLiveOutput, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, webcastIsLiveOutput, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WebcastIsLiveOutput" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="webcastIsLiveOutput"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WebcastIsLiveOutput webcastIsLiveOutput, JsonSerializerOptions jsonSerializerOptions)
        {
            if (webcastIsLiveOutput.DataOption.IsSet && webcastIsLiveOutput.Data == null)
                throw new ArgumentNullException(nameof(webcastIsLiveOutput.Data), "Property is required for class WebcastIsLiveOutput.");

            if (webcastIsLiveOutput.DataOption.IsSet)
            {
                writer.WritePropertyName("data");
                JsonSerializer.Serialize(writer, webcastIsLiveOutput.Data, jsonSerializerOptions);
            }
        }
    }
}
