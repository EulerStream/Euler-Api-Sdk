...
inputSpec: ./csharp-sdk/build/openapi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{97AD071F-ACD6-485A-842F-2018C61487DC}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAccountsApi>();
            IRetrieveAccountSelfApiResponse apiResponse = await api.RetrieveAccountSelfAsync("todo");
            RetrieveAccountResponse? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Euler Stream Sign API
- appVersion: dev
- appDescription: Sign Server API Documentation
