    ...
    public class ApiTestsBase
    {
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) => Host.CreateDefaultBuilder(args)
            .ConfigureApi((context, services, options) =>
            {
                ...
                ApiKeyToken apiKeyToken1 = new(apiKeyTokenValue1, ClientUtils.ApiKeyHeader.ApiKey, timeout: TimeSpan.FromSeconds(1));
                ...
                ApiKeyToken apiKeyToken3 = new(apiKeyTokenValue3, ClientUtils.ApiKeyHeader.X_jwt_key, timeout: TimeSpan.FromSeconds(1));
