...
namespace EulerApiSdk.Model
{
    ...
    /// </summary>
    public partial class WhirlCaptchaResponse : IValidatableObject
    {
        /// <summary>
    ...
    public class WhirlCaptchaResponseJsonConverter : JsonConverter<WhirlCaptchaResponse>
    {
        ...
        public override WhirlCaptchaResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="WhirlCaptchaResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="whirlCaptchaResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, WhirlCaptchaResponse whirlCaptchaResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, whirlCaptchaResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="WhirlCaptchaResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="whirlCaptchaResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, WhirlCaptchaResponse whirlCaptchaResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (whirlCaptchaResponse.Response != null)
            {
                ...
                JsonSerializer.Serialize(writer, whirlCaptchaResponse.Response, jsonSerializerOptions);
            }
            else
