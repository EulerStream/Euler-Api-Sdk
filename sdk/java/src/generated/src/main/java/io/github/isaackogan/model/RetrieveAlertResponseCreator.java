  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!RetrieveAlertResponseCreator.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetrieveAlertResponseCreator is not found in the empty JSON string", RetrieveAlertResponseCreator.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!RetrieveAlertResponseCreator.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetrieveAlertResponseCreator` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("last_nickname") != null && !jsonObj.get("last_nickname").isJsonNull()) && !jsonObj.get("last_nickname").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `last_nickname` to be a primitive type in the JSON string but got `%s`", jsonObj.get("last_nickname").toString()));
      }
      if ((jsonObj.get("last_avatar_url") != null && !jsonObj.get("last_avatar_url").isJsonNull()) && !jsonObj.get("last_avatar_url").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `last_avatar_url` to be a primitive type in the JSON string but got `%s`", jsonObj.get("last_avatar_url").toString()));
      }
      ...
      if (!jsonObj.get("state_label").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `state_label` to be a primitive type in the JSON string but got `%s`", jsonObj.get("state_label").toString()));
      }
