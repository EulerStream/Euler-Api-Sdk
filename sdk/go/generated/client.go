...
// APIClient manages communication with the Euler Stream Sign API API vdev
...
type APIClient struct {
	...
	TikTokCaptchasAPI *TikTokCaptchasAPIService

	TikTokGeneralAPI *TikTokGeneralAPIService
