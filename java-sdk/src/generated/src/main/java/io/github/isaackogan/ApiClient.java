...
import io.github.isaackogan.auth.Authentication;
import io.github.isaackogan.auth.HttpBasicAuth;
import io.github.isaackogan.auth.HttpBearerAuth;
import io.github.isaackogan.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    new ServerConfiguration(
      "https://tiktok.enterprise.eulerstream.com",
    ...
    public ApiClient() {
        ...
        authentications.put("api_key_query", new ApiKeyAuth("query", "apiKey"));
        authentications.put("api_key_header", new ApiKeyAuth("header", "x-api-key"));
        authentications.put("jwt_key_header", new ApiKeyAuth("header", "x-jwt-key"));
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/dev/java");
     ...
     * @return a {@link io.github.isaackogan.ApiClient} object
     */
    ...
    */
     ...
     * @throws io.github.isaackogan.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.github.isaackogan.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.github.isaackogan.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.github.isaackogan.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.github.isaackogan.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.github.isaackogan.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.github.isaackogan.ApiException If fails to update the parameters
     */
     ...
     * @throws io.github.isaackogan.ApiException If fail to serialize the request body object into a string
     */
